    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                {{-- <nav class="navbar navbar-expand topbar mb-4 static-top shadow" style="background-color: #bc3333; color: white;"> --}}
                {{-- <nav class="navbar navbar-expand topbar mb-4 static-top shadow" style="background-color: #000000; color: white;"> --}}
                    ...
                    <form
                        ...
                        class="d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm shadow-sm" style="background-color: #bc3333; color: white;"><i
